...
const config = getDefaultConfig({
  ...
  wallets: [
    ...
    //   wallets: [
    //     walletConnectWallet({ projectId: process.env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID ?? "" }),
    //     rainbowWallet({ projectId: process.env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID ?? "" }),
    //   ],
    // },
  ],
